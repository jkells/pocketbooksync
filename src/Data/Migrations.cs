...
namespace PocketBookSync.Data
{
    public static class Migrations
    {
        public static async Task MigrateAsync(AppDbContext db)
        {
            ...
            await db.Database.ExecuteSqlCommandAsync("CREATE TABLE IF NOT EXISTS Config (ID INTEGER PRIMARY KEY, XPocketBookUsername TEXT, XPocketBookPassword TEXT);");
            await db.Database.ExecuteSqlCommandAsync("CREATE TABLE IF NOT EXISTS Accounts (ID INTEGER PRIMARY KEY, XUsername TEXT, XPassword TEXT, Type STRING, PocketBookAccountNumber STRING, AccountReference STRING);");
